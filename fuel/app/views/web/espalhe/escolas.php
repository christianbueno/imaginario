...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta charset="utf-8">
    <title>Imagina.RIO > espalhe o amor > escolas</title>
        ...
        <div class="texto-wrapper" style="margin-bottom:250px;">
            <h1>Espalhe sua paixão!</h1>
                ...
                <div class="shareBox">
                    ...
                    <a style="margin-right:7px;" class="btn btn-info btn-large" href="http://twitter.com/home?status=Para sua escola participar do ImaginaRio 2013, cadastre-se em http://www.imaginario.etc.br/escolas e receba as orientações por e-mail"  onclick="return popitup('http://twitter.com/home?status=Para participar do ImaginaRio 2013, cadastre-se em www.imaginario.etc.br/individual e receba a programação completa por e-mail')">
