    ...
    <div id="vignette" class="container-fluid">     
        ...
        <h1>Fale conosco</h1>
			...
			*width: 102%; /* this one for IE */
			...
			.default .sidebar .title, .default .leftSidebar .title, .default .rightSidebar .title {
			color: #F15C25;
			}
			.default .sidebar .subtitle, .default .leftSidebar .subtitle, .default .rightSidebar .subtitle {
			color: #669940;
			}
			.default .footer {
			...
			<input class="infusion-field-input-container" id="inf_custom_Descricao" name="inf_custom_Descricao" type="text" />
			</div>
			<div>
			...
			<button style="" type="submit" value="Enviar">Enviar</button>
			</div>
			</div>
			</form>
